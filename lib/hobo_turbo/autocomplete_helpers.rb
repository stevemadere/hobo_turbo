...
=begin rdoc
     ...
     - +class_of_association+: The class (model) of the target of the association that is autocompleted. e.g. City.  Defaults to member_name.classify.constantize.  If this class implements a lookup_by_name(objname) method, that will be used, otherwise find_by_name(objname) will be used.
